                ...
                {step1.options.map((option, index) => (
                  ...
                  >
                    <button
                      ...
                      className={`w-full max-w-md px-4 py-3 md:px-6 md:py-4 border-2 rounded-lg md:rounded-xl font-semibold hover:shadow-soft transition-all duration-300 flex items-center justify-center gap-3 text-sm md:text-base shadow-soft ${
                        option.id === 'resume' 
